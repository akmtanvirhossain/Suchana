...
public class Destruction2 extends Activity {
    ...
    private void DataSave() {
        try {
            ...
            objSave.setH14c1a((chkH14c1a.isChecked() ? "1" :(chkH14c1a.isShown()? "2":"")));
            objSave.setH14c1b((chkH14c1b.isChecked() ? "1" :(chkH14c1b.isShown()? "2":"")));
            objSave.setH14c1c((chkH14c1c.isChecked() ? "1" :(chkH14c1c.isShown()? "2":"")));
            objSave.setH14c1d((chkH14c1d.isChecked() ? "1" :(chkH14c1d.isShown()? "2":"")));
            objSave.setH14c1e((chkH14c1e.isChecked() ? "1" :(chkH14c1e.isShown()? "2":"")));
            objSave.setH14c1f((chkH14c1f.isChecked() ? "1" :(chkH14c1f.isShown()? "2":"")));
            objSave.setH14c1g((chkH14c1g.isChecked() ? "1" :(chkH14c1g.isShown()? "2":"")));
            objSave.setH14c1h((chkH14c1h.isChecked() ? "1" :(chkH14c1h.isShown()? "2":"")));
            objSave.setH14c1i((chkH14c1i.isChecked() ? "1" :(chkH14c1i.isShown()? "2":"")));
            objSave.setH14c1j((chkH14c1j.isChecked() ? "1" :(chkH14c1j.isShown()? "2":"")));
            objSave.setH14c1k((chkH14c1k.isChecked() ? "1" :(chkH14c1k.isShown()? "2":"")));
            objSave.setH14c1l((chkH14c1l.isChecked() ? "1" :(chkH14c1l.isShown()? "2":"")));
            objSave.setH14c1m((chkH14c1m.isChecked() ? "1" :(chkH14c1m.isShown()? "2":"")));
            objSave.setH14c1n((chkH14c1n.isChecked() ? "1" :(chkH14c1n.isShown()? "2":"")));
            objSave.setH14c1o((chkH14c1o.isChecked() ? "1" :(chkH14c1o.isShown()? "2":"")));
            objSave.setH14c1p((chkH14c1p.isChecked() ? "1" :(chkH14c1p.isShown()? "2":"")));
            objSave.setH14c1q((chkH14c1q.isChecked() ? "1" :(chkH14c1q.isShown()? "2":"")));
            objSave.setH14c1r((chkH14c1r.isChecked() ? "1" :(chkH14c1r.isShown()? "2":"")));
            objSave.setH14c1s((chkH14c1s.isChecked() ? "1" :(chkH14c1s.isShown()? "2":"")));
            objSave.setH14c1t((chkH14c1t.isChecked() ? "1" :(chkH14c1t.isShown()? "2":"")));
            objSave.setH14c1x((chkH14c1x.isChecked() ? "1" :(chkH14c1x.isShown()? "2":"")));
