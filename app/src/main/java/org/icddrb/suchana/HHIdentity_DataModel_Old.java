...
public class HHIdentity_DataModel_Old {
    ...
    public List<HHIdentity_DataModel_Old> SelectAll(Context context, String SQL) {
        Connection C = new Connection(context);
        List<HHIdentity_DataModel_Old> data = new ArrayList<HHIdentity_DataModel_Old>();
        HHIdentity_DataModel_Old d = new HHIdentity_DataModel_Old();
        Cursor cur = C.ReadData(SQL);

        cur.moveToFirst();
        while (!cur.isAfterLast()) {
            d = new HHIdentity_DataModel_Old();
    ...
    public List<HHIdentity_DataModel_Old> SelectAllList(Context context, String SQL) {
        Connection C = new Connection(context);
        List<HHIdentity_DataModel_Old> data = new ArrayList<HHIdentity_DataModel_Old>();
        HHIdentity_DataModel_Old d = new HHIdentity_DataModel_Old();
        Cursor cur = C.ReadData(SQL);
