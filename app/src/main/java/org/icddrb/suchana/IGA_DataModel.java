...
public class IGA_DataModel {
    ...
    private String _H18b2b8 = "";
    private String _H18b2b9 = "";
    private String _H18b2b9X = "";
    private String _H18b1c = "";
    private String _H18b2c = "";
    private String _H18b2c0 = "";
    ...
    private String _H18b2c6X = "";
    private String _H18b1d = "";
    private String _H18b2d = "";
    private String _H18b2d0 = "";
    ...
    private String _H18b2e6X = "";
    private String _H18b1f = "";
    private String _H18b2f = "";
    private String _H18b2f0 = "";
    ...
    private String _H18b2g8 = "";
    private String _H18b2g9 = "";
    private String _H18b2g9X = "";
    private String _H18b1h = "";
    private String _H18b2h = "";
    private String _H18b2h0 = "";
    ...
    private String _H18b2h8 = "";
    private String _H18b2h9 = "";
    private String _H18b2h9X = "";
    private String _H18b1i = "";
    private String _H18b2i = "";
    private String _H18b2i0 = "";
    ...
    public String getH18b2a0() {
        return _H18b2a0;
    }
    public void setH18b2a0(String newValue) {
        _H18b2a0 = newValue;
    }
    ...
    public String getH18b2b0() {
        return _H18b2b0;
    }
    public void setH18b2b0(String newValue) {
        _H18b2b0 = newValue;
    }
    ...
    public String getH18b2b8() {
        return _H18b2b8;
    }

    public void setH18b2b8(String newValue) {
        _H18b2b8 = newValue;
    }

    public String getH18b2b9() {
        return _H18b2b9;
    }

    public void setH18b2b9(String newValue) {
        _H18b2b9 = newValue;
    }

    public String getH18b2b9X() {
        return _H18b2b9X;
    }

    public void setH18b2b9X(String newValue) {
        _H18b2b9X = newValue;
    }
    ...
    public String getH18b2c0() {
        return _H18b2c0;
    }
    public void setH18b2c0(String newValue) {
        _H18b2c0 = newValue;
    }
    ...
    public String getH18b2c6X() {
        return _H18b2c6X;
    }

    public void setH18b2c6X(String newValue) {
        _H18b2c6X = newValue;
    }
    ...
    public String getH18b2d0() {
        return _H18b2d0;
    }
    public void setH18b2d0(String newValue) {
        _H18b2d0 = newValue;
    }
    ...
    public String getH18b2e0() {
        return _H18b2e0;
    }
    public void setH18b2e0(String newValue) {
        _H18b2e0 = newValue;
    }
    ...
    public String getH18b2e6X() {
        return _H18b2e6X;
    }

    public void setH18b2e6X(String newValue) {
        _H18b2e6X = newValue;
    }
    ...
    public String getH18b2f0() {
        return _H18b2f0;
    }
    public void setH18b2f0(String newValue) {
        _H18b2f0 = newValue;
    }
    ...
    public String getH18b2g0() {
        return _H18b2g0;
    }
    public void setH18b2g0(String newValue) {
        _H18b2g0 = newValue;
    }
    ...
    public String getH18b2g8() {
        return _H18b2g8;
    }

    public void setH18b2g8(String newValue) {
        _H18b2g8 = newValue;
    }

    public String getH18b2g9() {
        return _H18b2g9;
    }

    public void setH18b2g9(String newValue) {
        _H18b2g9 = newValue;
    }
    public String getH18b2g9X() {
        return _H18b2g9X;
    }

    public void setH18b2g9X(String newValue) {
        _H18b2g9X = newValue;
    }
    ...
    public String getH18b2h0() {
        return _H18b2h0;
    }
    public void setH18b2h0(String newValue) {
        _H18b2h0 = newValue;
    }
    ...
    public String getH18b2h8() {
        return _H18b2h8;
    }

    public void setH18b2h8(String newValue) {
        _H18b2h8 = newValue;
    }


    public String getH18b2h9() {
        return _H18b2h9;
    }

    public void setH18b2h9(String newValue) {
        _H18b2h9 = newValue;
    }


    public String getH18b2h9X() {
        return _H18b2h9X;
    }

    public void setH18b2h9X(String newValue) {
        _H18b2h9X = newValue;
    }
    ...
    public String getH18b2i0() {
        return _H18b2i0;
    }
    public void setH18b2i0(String newValue) {
        _H18b2i0 = newValue;
    }
    ...
    public String getH18b2j0() {
        return _H18b2j0;
    }
    public void setH18b2j0(String newValue) {
        _H18b2j0 = newValue;
    }
...
*/
    ...
    private String SaveData(Context context) {
        ...
        String SQL = "";
        try {
            SQL = "Insert into " + TableName + " (RND,SuchanaID,H18b1a,H18b2a,H18b2a0,H18b2a1,H18b2a2,H18b2a3,H18b2a4,H18b2a5,H18b2a6,H18b2a7,H18b2a7X,H18b1b,H18b2b,H18b2b0,H18b2b1,H18b2b2,H18b2b3,H18b2b4,H18b2b5,H18b2b6,H18b2b7,H18b2b8,H18b2b9,H18b2b9X,H18b1c,H18b2c,H18b2c0,H18b2c1,H18b2c2,H18b2c3,H18b2c4,H18b2c5,H18b2c6,H18b2c6X,H18b1d,H18b2d,H18b2d0,H18b2d1,H18b2d2,H18b2d3,H18b2d4,H18b2d5,H18b2d6,H18b2d7,H18b2d7X,H18b1e,H18b2e,H18b2e0,H18b2e1,H18b2e2,H18b2e3,H18b2e4,H18b2e5,H18b2e6,H18b2e6X,H18b1f,H18b2f,H18b2f0,H18b2f1,H18b2f2,H18b2f3,H18b2f4,H18b2f5,H18b2f6,H18b2f7,H18b2f7X,H18b1g,H18b2g,H18b2g0,H18b2g1,H18b2g2,H18b2g3,H18b2g4,H18b2g5,H18b2g6,H18b2g7,H18b2g8,H18b2g9,H18b2g9X,H18b1h,H18b2h,H18b2h0,H18b2h1,H18b2h2,H18b2h3,H18b2h4,H18b2h5,H18b2h6,H18b2h7,H18b2h8,H18b2h9,H18b2h9X,H18b1i,H18b2i,H18b2i0,H18b2i1,H18b2i2,H18b2i3,H18b2i4,H18b2i5,H18b2i5X,H18b1j,H18b2j,H18b2j0,H18b2j1,H18b2j2,H18b2j3,H18b2j4,H18b2j5,H18b2j5X,StartTime,EndTime,UserId,EntryUser,Lat,Lon,EnDt,Upload)Values('" + _RND + "', '" + _SuchanaID + "', '" + _H18b1a + "','" + _H18b2a + "', '" + _H18b2a0 + "', '" + _H18b2a1 + "', '" + _H18b2a2 + "', '" + _H18b2a3 + "', '" + _H18b2a4 + "', '" + _H18b2a5 + "', '" + _H18b2a6 + "', '" + _H18b2a7 + "', '" + _H18b2a7X + "', '" + _H18b1b + "','" + _H18b2b + "', '" + _H18b2b0 + "', '" + _H18b2b1 + "', '" + _H18b2b2 + "', '" + _H18b2b3 + "', '" + _H18b2b4 + "', '" + _H18b2b5 + "', '" + _H18b2b6 + "', '" + _H18b2b7 + "', '" + _H18b2b8 + "', '" + _H18b2b9 + "', '" + _H18b2b9X + "', '" + _H18b1c + "','" + _H18b2c + "', '" + _H18b2c0 + "', '" + _H18b2c1 + "', '" + _H18b2c2 + "', '" + _H18b2c3 + "', '" + _H18b2c4 + "', '" + _H18b2c5 + "', '" + _H18b2c6 + "', '" + _H18b2c6X + "', '" + _H18b1d + "','" + _H18b2d + "', '" + _H18b2d0 + "', '" + _H18b2d1 + "', '" + _H18b2d2 + "', '" + _H18b2d3 + "', '" + _H18b2d4 + "', '" + _H18b2d5 + "', '" + _H18b2d6 + "', '" + _H18b2d7 + "', '" + _H18b2d7X + "', '" + _H18b1e + "','" + _H18b2e + "', '" + _H18b2e0 + "', '" + _H18b2e1 + "', '" + _H18b2e2 + "', '" + _H18b2e3 + "', '" + _H18b2e4 + "', '" + _H18b2e5 + "', '" + _H18b2e6 + "', '" + _H18b2e6X + "', '" + _H18b1f + "','" + _H18b2f + "', '" + _H18b2f0 + "', '" + _H18b2f1 + "', '" + _H18b2f2 + "', '" + _H18b2f3 + "', '" + _H18b2f4 + "', '" + _H18b2f5 + "', '" + _H18b2f6 + "', '" + _H18b2f7 + "', '" + _H18b2f7X + "', '" + _H18b1g + "','" + _H18b2g + "', '" + _H18b2g0 + "', '" + _H18b2g1 + "', '" + _H18b2g2 + "', '" + _H18b2g3 + "', '" + _H18b2g4 + "', '" + _H18b2g5 + "', '" + _H18b2g6 + "', '" + _H18b2g7 + "', '" + _H18b2g8 + "', '" + _H18b2g9 + "', '" + _H18b2g9X + "', '" + _H18b1h + "','" + _H18b2h + "', '" + _H18b2h0 + "', '" + _H18b2h1 + "', '" + _H18b2h2 + "', '" + _H18b2h3 + "', '" + _H18b2h4 + "', '" + _H18b2h5 + "', '" + _H18b2h6 + "', '" + _H18b2h7 + "', '" + _H18b2h8 + "', '" + _H18b2h9 + "', '" + _H18b2h9X + "', '" + _H18b1i + "','" + _H18b2i + "', '" + _H18b2i0 + "', '" + _H18b2i1 + "', '" + _H18b2i2 + "', '" + _H18b2i3 + "', '" + _H18b2i4 + "', '" + _H18b2i5 + "', '" + _H18b2i5X + "', '" + _H18b1j + "','" + _H18b2j + "', '" + _H18b2j0 + "', '" + _H18b2j1 + "', '" + _H18b2j2 + "', '" + _H18b2j3 + "', '" + _H18b2j4 + "', '" + _H18b2j5 + "', '" + _H18b2j5X + "', '" + _StartTime + "', '" + _EndTime + "', '" + _UserId + "', '" + _EntryUser + "', '" + _Lat + "', '" + _Lon + "', '" + _EnDt + "', '" + _Upload + "')";
            C.Save(SQL);
        } catch (Exception e) {
            response = e.getMessage();
        }
    ...
    private String UpdateData(Context context) {
        ...
        String SQL = "";
        try {
            SQL = "Update " + TableName + " Set Upload='2',RND = '" + _RND + "',SuchanaID = '" + _SuchanaID + "',H18b1a = '" + _H18b1a + "',H18b2a = '" + _H18b2a + "',H18b2a0 = '" + _H18b2a0 + "',H18b2a1 = '" + _H18b2a1 + "',H18b2a2 = '" + _H18b2a2 + "',H18b2a3 = '" + _H18b2a3 + "',H18b2a4 = '" + _H18b2a4 + "',H18b2a5 = '" + _H18b2a5 + "',H18b2a6 = '" + _H18b2a6 + "',H18b2a7 = '" + _H18b2a7 + "',H18b2a7X = '" + _H18b2a7X + "',H18b1b = '" + _H18b1b + "',H18b2b = '" + _H18b2b + "',H18b2b0 = '" + _H18b2b0 + "',H18b2b1 = '" + _H18b2b1 + "',H18b2b2 = '" + _H18b2b2 + "',H18b2b3 = '" + _H18b2b3 + "',H18b2b4 = '" + _H18b2b4 + "',H18b2b5 = '" + _H18b2b5 + "',H18b2b6 = '" + _H18b2b6 + "',H18b2b7 = '" + _H18b2b7 + "',H18b2b8 = '" + _H18b2b8 + "',H18b2b9 = '" + _H18b2b9 + "',H18b2b9X = '" + _H18b2b9X + "',H18b1c = '" + _H18b1c + "',H18b2c = '" + _H18b2c + "',H18b2c0 = '" + _H18b2c0 + "',H18b2c1 = '" + _H18b2c1 + "',H18b2c2 = '" + _H18b2c2 + "',H18b2c3 = '" + _H18b2c3 + "',H18b2c4 = '" + _H18b2c4 + "',H18b2c5 = '" + _H18b2c5 + "',H18b2c6 = '" + _H18b2c6 + "',H18b2c6X = '" + _H18b2c6X + "',H18b1d = '" + _H18b1d + "',H18b2d = '" + _H18b2d + "',H18b2d0 = '" + _H18b2d0 + "',H18b2d1 = '" + _H18b2d1 + "',H18b2d2 = '" + _H18b2d2 + "',H18b2d3 = '" + _H18b2d3 + "',H18b2d4 = '" + _H18b2d4 + "',H18b2d5 = '" + _H18b2d5 + "',H18b2d6 = '" + _H18b2d6 + "',H18b2d7 = '" + _H18b2d7 + "',H18b2d7X = '" + _H18b2d7X + "',H18b1e = '" + _H18b1e + "',H18b2e = '" + _H18b2e + "',H18b2e0 = '" + _H18b2e0 + "',H18b2e1 = '" + _H18b2e1 + "',H18b2e2 = '" + _H18b2e2 + "',H18b2e3 = '" + _H18b2e3 + "',H18b2e4 = '" + _H18b2e4 + "',H18b2e5 = '" + _H18b2e5 + "',H18b2e6 = '" + _H18b2e6 + "',H18b2e6X = '" + _H18b2e6X + "',H18b1f = '" + _H18b1f + "',H18b2f = '" + _H18b2f + "',H18b2f0 = '" + _H18b2f0 + "',H18b2f1 = '" + _H18b2f1 + "',H18b2f2 = '" + _H18b2f2 + "',H18b2f3 = '" + _H18b2f3 + "',H18b2f4 = '" + _H18b2f4 + "',H18b2f5 = '" + _H18b2f5 + "',H18b2f6 = '" + _H18b2f6 + "',H18b2f7 = '" + _H18b2f7 + "',H18b2f7X = '" + _H18b2f7X + "',H18b1g = '" + _H18b1g + "',H18b2g = '" + _H18b2g + "',H18b2g0 = '" + _H18b2g0 + "',H18b2g1 = '" + _H18b2g1 + "',H18b2g2 = '" + _H18b2g2 + "',H18b2g3 = '" + _H18b2g3 + "',H18b2g4 = '" + _H18b2g4 + "',H18b2g5 = '" + _H18b2g5 + "',H18b2g6 = '" + _H18b2g6 + "',H18b2g7 = '" + _H18b2g7 + "',H18b2g8 = '" + _H18b2g8 + "',H18b2g9 = '" + _H18b2g9 + "',H18b2g9X = '" + _H18b2g9X + "',H18b1h = '" + _H18b1h + "',H18b2h = '" + _H18b2h + "',H18b2h0 = '" + _H18b2h0 + "',H18b2h1 = '" + _H18b2h1 + "',H18b2h2 = '" + _H18b2h2 + "',H18b2h3 = '" + _H18b2h3 + "',H18b2h4 = '" + _H18b2h4 + "',H18b2h5 = '" + _H18b2h5 + "',H18b2h6 = '" + _H18b2h6 + "',H18b2h7 = '" + _H18b2h7 + "',H18b2h8 = '" + _H18b2h8 + "',H18b2h9 = '" + _H18b2h9 + "',H18b2h9X = '" + _H18b2h9X + "',H18b1i = '" + _H18b1i + "',H18b2i = '" + _H18b2i + "',H18b2i0 = '" + _H18b2i0 + "',H18b2i1 = '" + _H18b2i1 + "',H18b2i2 = '" + _H18b2i2 + "',H18b2i3 = '" + _H18b2i3 + "',H18b2i4 = '" + _H18b2i4 + "',H18b2i5 = '" + _H18b2i5 + "',H18b2i5X = '" + _H18b2i5X + "',H18b1j = '" + _H18b1j + "',H18b2j = '" + _H18b2j + "',H18b2j0 = '" + _H18b2j0 + "',H18b2j1 = '" + _H18b2j1 + "',H18b2j2 = '" + _H18b2j2 + "',H18b2j3 = '" + _H18b2j3 + "',H18b2j4 = '" + _H18b2j4 + "',H18b2j5 = '" + _H18b2j5 + "',H18b2j5X = '" + _H18b2j5X + "'  Where RND='" + _RND + "' and SuchanaID='" + _SuchanaID + "'";
            C.Save(SQL);
        } catch (Exception e) {
            response = e.getMessage();
        }
    ...
    public List<IGA_DataModel> SelectAll(Context context, String SQL) {
        ...
        while (!cur.isAfterLast()) {
            ...
            d._H18b2a0 = cur.getString(cur.getColumnIndex("H18b2a0"));
            ...
            d._H18b2b0 = cur.getString(cur.getColumnIndex("H18b2b0"));
            ...
            d._H18b2b8 = cur.getString(cur.getColumnIndex("H18b2b8"));
            d._H18b2b9 = cur.getString(cur.getColumnIndex("H18b2b9"));
            d._H18b2b9X = cur.getString(cur.getColumnIndex("H18b2b9X"));
            d._H18b1c = cur.getString(cur.getColumnIndex("H18b1c"));
            d._H18b2c = cur.getString(cur.getColumnIndex("H18b2c"));
            d._H18b2c0 = cur.getString(cur.getColumnIndex("H18b2c0"));
            ...
            d._H18b2c6X = cur.getString(cur.getColumnIndex("H18b2c6X"));
            d._H18b1d = cur.getString(cur.getColumnIndex("H18b1d"));
            d._H18b2d = cur.getString(cur.getColumnIndex("H18b2d"));
            d._H18b2d0 = cur.getString(cur.getColumnIndex("H18b2d0"));
            ...
            d._H18b2e0 = cur.getString(cur.getColumnIndex("H18b2e0"));
            ...
            d._H18b2e6X = cur.getString(cur.getColumnIndex("H18b2e6X"));
            d._H18b1f = cur.getString(cur.getColumnIndex("H18b1f"));
            d._H18b2f = cur.getString(cur.getColumnIndex("H18b2f"));
            d._H18b2f0 = cur.getString(cur.getColumnIndex("H18b2f0"));
            ...
            d._H18b2g0 = cur.getString(cur.getColumnIndex("H18b2g0"));
            ...
            d._H18b2g8 = cur.getString(cur.getColumnIndex("H18b2g8"));
            d._H18b2g9 = cur.getString(cur.getColumnIndex("H18b2g9"));
            d._H18b2g9X = cur.getString(cur.getColumnIndex("H18b2g9X"));
            d._H18b1h = cur.getString(cur.getColumnIndex("H18b1h"));
            d._H18b2h = cur.getString(cur.getColumnIndex("H18b2h"));
            d._H18b2h0 = cur.getString(cur.getColumnIndex("H18b2h0"));
            ...
            d._H18b2h8 = cur.getString(cur.getColumnIndex("H18b2h8"));
            d._H18b2h9 = cur.getString(cur.getColumnIndex("H18b2h9"));
            d._H18b2h9X = cur.getString(cur.getColumnIndex("H18b2h9X"));
            d._H18b1i = cur.getString(cur.getColumnIndex("H18b1i"));
            d._H18b2i = cur.getString(cur.getColumnIndex("H18b2i"));
            d._H18b2i0 = cur.getString(cur.getColumnIndex("H18b2i0"));
            ...
            d._H18b2j0 = cur.getString(cur.getColumnIndex("H18b2j0"));
