...
public class HHIdentity_DataModel_Final {
    ...
    public List<HHIdentity_DataModel_Final> SelectAll(Context context, String SQL) {
        Connection C = new Connection(context);
        List<HHIdentity_DataModel_Final> data = new ArrayList<HHIdentity_DataModel_Final>();
        HHIdentity_DataModel_Final d = new HHIdentity_DataModel_Final();
        Cursor cur = C.ReadData(SQL);

        cur.moveToFirst();
        while (!cur.isAfterLast()) {
            d = new HHIdentity_DataModel_Final();
    ...
    public List<HHIdentity_DataModel_Final> SelectAllList(Context context, String SQL) {
        Connection C = new Connection(context);
        List<HHIdentity_DataModel_Final> data = new ArrayList<HHIdentity_DataModel_Final>();
        HHIdentity_DataModel_Final d = new HHIdentity_DataModel_Final();
        Cursor cur = C.ReadData(SQL);
