...
//<activity android:name=".Illness" android:label="Illness" />
...
public class Illness extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            setContentView(R.layout.illness);
            ...
            cmdBack.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    AlertDialog.Builder adb = new AlertDialog.Builder(Illness.this);
                    adb.setTitle("Close");
            ...
            rdogrpH171.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(RadioGroup radioGroup, int radioButtonID) {
                    ...
                    if (rbData.equalsIgnoreCase("0")) {
                        ...
                        lineH171f.setVisibility(View.GONE);
                        ...
                        lineH171f.setVisibility(View.VISIBLE);
                    }
                }
            ...
            spnH171a.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                    if (spnH171a.getSelectedItem().toString().length() == 0) return;
                    String spnData = Connection.SelectedSpinnerValue(spnH171a.getSelectedItem().toString(), "-");
                    if (spnData.equalsIgnoreCase("22")) {
                        secH171aX.setVisibility(View.VISIBLE);
                        lineH171aX.setVisibility(View.VISIBLE);
                    } else {
                        txtH171aX.setText("");
            ...
            spnH171b.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                @Override
                public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                    if (spnH171b.getSelectedItem().toString().length() == 0) return;
                    String spnData = Connection.SelectedSpinnerValue(spnH171b.getSelectedItem().toString(), "-");
            ...
            Connection.MessageBox(Illness.this, e.getMessage());
            return;
        }
    }
    ...
    private void DataSave() {
        try {
            ...
            if (txtRnd.getText().toString().length() == 0 & secRnd.isShown()) {
                Connection.MessageBox(Illness.this, "Required field: রাউন্ড নাম্বার.");
                txtRnd.requestFocus();
                return;
                ...
                Connection.MessageBox(Illness.this, "Value should be between 1 and 5(রাউন্ড নাম্বার).");
                txtRnd.requestFocus();
                return;
            } else if (txtSuchanaID.getText().toString().length() == 0 & secSuchanaID.isShown()) {
                Connection.MessageBox(Illness.this, "Required field: উপকারভোগী সদস্য আইডি.");
                txtSuchanaID.requestFocus();
                return;
            } else if (!rdoH1711.isChecked() & !rdoH1712.isChecked() & secH171.isShown()) {
                Connection.MessageBox(Illness.this, "Select anyone options from (গত ১৫ দিনে  খানার কোন  সদস্য অসুস্থ হয়েছে).");
                rdoH1711.requestFocus();
                return;
            } else if (txtSlNo.getText().toString().length() == 0 & secSlNo.isShown()) {
                Connection.MessageBox(Illness.this, "Required field: লাইন নং.");
                ...
                Connection.MessageBox(Illness.this, "Value should be between 01 and 30(লাইন নং).");
                txtSlNo.requestFocus();
                return;
            } else if (spnH171a.getSelectedItemPosition() == 0 & secH171a.isShown()) {
                Connection.MessageBox(Illness.this, "Required field: বিগত 15 দিনের মধ্যে অসুস্থতার ধরন.");
                spnH171a.requestFocus();
                return;
            } else if (txtH171aX.getText().toString().length() == 0 & secH171aX.isShown()) {
                Connection.MessageBox(Illness.this, "Required field: অন্যান্য.");
                txtH171aX.requestFocus();
                return;
            } else if (spnH171b.getSelectedItemPosition() == 0 & secH171b.isShown()) {
                Connection.MessageBox(Illness.this, "Required field: প্রথম কোন চিকিৎসা নেয়া হয়েছিল.");
                ...
                Connection.MessageBox(Illness.this, "Required field: যদি প্রথম চিকিৎসা HCP হয়, তবে অসুস্থতা শুরুর কত দিন পরে গিয়েছিলেন.");
                ...
                Connection.MessageBox(Illness.this, "Value should be between 0 and 999(যদি প্রথম চিকিৎসা HCP হয়, তবে অসুস্থতা শুরুর কত দিন পরে গিয়েছিলেন).");
                txtH171c.requestFocus();
                return;
            } else if (txtH171d.getText().toString().length() == 0 & secH171d.isShown()) {
                Connection.MessageBox(Illness.this, "Required field: অসুস্থতার মোট সময়কাল (শুরু থেকে সুস্থ হওয়া পর্যন্ত) (দিন).");
                ...
                Connection.MessageBox(Illness.this, "Value should be between 000 and 999(অসুস্থতার মোট সময়কাল (শুরু থেকে সুস্থ হওয়া পর্যন্ত) (দিন)).");
                txtH171d.requestFocus();
                return;
            } else if (txtH171VCost.getText().toString().length() == 0 & secH171VCost.isShown()) {
                Connection.MessageBox(Illness.this, "Required field: চিকিৎসার জন্য খরচ: ভিজিট.");
                ...
                Connection.MessageBox(Illness.this, "Value should be between 0 and 9999(চিকিৎসার জন্য খরচ: ভিজিট).");
                txtH171VCost.requestFocus();
                return;
            } else if (txtH171TCost.getText().toString().length() == 0 & secH171TCost.isShown()) {
                Connection.MessageBox(Illness.this, "Required field: চিকিৎসার জন্য খরচ: পরীক্ষা.");
                ...
                Connection.MessageBox(Illness.this, "Value should be between 0 and 99999(চিকিৎসার জন্য খরচ: পরীক্ষা).");
                txtH171TCost.requestFocus();
                return;
            } else if (txtH171TrCost.getText().toString().length() == 0 & secH171TrCost.isShown()) {
                Connection.MessageBox(Illness.this, "Required field: চিকিৎসার জন্য খরচ: যাতায়াত.");
                ...
                Connection.MessageBox(Illness.this, "Value should be between 0 and 99999(চিকিৎসার জন্য খরচ: যাতায়াত).");
                txtH171TrCost.requestFocus();
                return;
            } else if (!rdoH171f1.isChecked() & !rdoH171f2.isChecked() & !rdoH171f3.isChecked() & secH171f.isShown()) {
                Connection.MessageBox(Illness.this, "Select anyone options from (আয়মূলক কর্মকান্ডে কি এই অসুস্থতা কি কোনো প্রভাব  ফেলেছিল? (>10 বছর)).");
                rdoH171f1.requestFocus();
                return;
            } else if (txtH171g.getText().toString().length() == 0 & secH171g.isShown()) {
                Connection.MessageBox(Illness.this, "Required field: হ্যাঁ হলে কত দিনের জন্যে?.");
                ...
                Connection.MessageBox(Illness.this, "Value should be between 1 and 999(হ্যাঁ হলে কত দিনের জন্যে?).");
                txtH171g.requestFocus();
                return;
            }
            ...
            Illness_DataModel objSave = new Illness_DataModel();
            ...
            if (status.length() == 0) {
                Connection.MessageBox(Illness.this, "Saved Successfully");
            } else {
                Connection.MessageBox(Illness.this, status);
                return;
            }
        } catch (Exception e) {
            Connection.MessageBox(Illness.this, e.getMessage());
