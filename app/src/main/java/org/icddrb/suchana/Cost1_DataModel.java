...
public class Cost1_DataModel{
    ...
    private String SaveData(Context context)
    {
        ...
        try
        {
            SQL = "Insert into "+ TableName +" (Rnd,SuchanaID,MSlNo,H811a,H811b,H811c,H811d,H812a,H812b,H812c,H812d,H813a,H813b,H813c,H813d,H814a,H814b,H814c,H814d,H815a,H815b,H815c,H815d,H816a,H816b,H816c,H816d,H821a,H821b,H821c,H821d,H831a,H831b,H831c,H831d,H832a,H832b,H832c,H832d,H841a,H841b,H841c,H841d,H842a,H842b,H842c,H842d,H851a,H851b,H851c,H851d,H861a,H861b,H861c,H861d,H862a,H862b,H862c,H862d,StartTime,EndTime,UserId,EntryUser,Lat,Lon,EnDt,Upload)Values('"+ _Rnd +"', '"+ _SuchanaID +"', '"+ _MSlNo +"', '"+ _H811a +"', '"+ _H811b +"', '"+ _H811c +"', '"+ _H811d +"', '"+ _H812a +"', '"+ _H812b +"', '"+ _H812c +"', '"+ _H812d +"', '"+ _H813a +"', '"+ _H813b +"', '"+ _H813c +"', '"+ _H813d +"', '"+ _H814a +"', '"+ _H814b +"', '"+ _H814c +"', '"+ _H814d +"', '"+ _H815a +"', '"+ _H815b +"', '"+ _H815c +"', '"+ _H815d +"', '"+ _H816a +"', '"+ _H816b +"', '"+ _H816c +"', '"+ _H816d +"', '"+ _H821a +"', '"+ _H821b +"', '"+ _H821c +"', '"+ _H821d +"', '"+ _H831a +"', '"+ _H831b +"', '"+ _H831c +"', '"+ _H831d +"', '"+ _H832a +"', '"+ _H832b +"', '"+ _H832c +"', '"+ _H832d +"', '"+ _H841a +"', '"+ _H841b +"', '"+ _H841c +"', '"+ _H841d +"', '"+ _H842a +"', '"+ _H842b +"', '"+ _H842c +"', '"+ _H842d +"', '"+ _H851a +"', '"+ _H851b +"', '"+ _H851c +"', '"+ _H851d +"', '"+ _H861a +"', '"+ _H861b +"', '"+ _H861c +"', '"+ _H861d +"', '"+ _H862a +"', '"+ _H862b +"', '"+ _H862c +"', '"+ _H862d +"', '"+ _StartTime +"', '"+ _EndTime +"', '"+ _UserId +"', '"+ _EntryUser +"', '"+ _Lat +"', '"+ _Lon +"', '"+ _EnDt +"', '"+ _Upload +"')";
            C.Save(SQL);
        }
        catch(Exception  e)
        {
    ...
    private String UpdateData(Context context)
    {
        ...
        try
        {
            SQL = "Update "+ TableName +" Set Upload='2',Rnd = '"+ _Rnd +"',SuchanaID = '"+ _SuchanaID +"',MSlNo = '"+ _MSlNo +"',H811a = '"+ _H811a +"',H811b = '"+ _H811b +"',H811c = '"+ _H811c +"',H811d = '"+ _H811d +"',H812a = '"+ _H812a +"',H812b = '"+ _H812b +"',H812c = '"+ _H812c +"',H812d = '"+ _H812d +"',H813a = '"+ _H813a +"',H813b = '"+ _H813b +"',H813c = '"+ _H813c +"',H813d = '"+ _H813d +"',H814a = '"+ _H814a +"',H814b = '"+ _H814b +"',H814c = '"+ _H814c +"',H814d = '"+ _H814d +"',H815a = '"+ _H815a +"',H815b = '"+ _H815b +"',H815c = '"+ _H815c +"',H815d = '"+ _H815d +"',H816a = '"+ _H816a +"',H816b = '"+ _H816b +"',H816c = '"+ _H816c +"',H816d = '"+ _H816d +"',H821a = '"+ _H821a +"',H821b = '"+ _H821b +"',H821c = '"+ _H821c +"',H821d = '"+ _H821d +"',H831a = '"+ _H831a +"',H831b = '"+ _H831b +"',H831c = '"+ _H831c +"',H831d = '"+ _H831d +"',H832a = '"+ _H832a +"',H832b = '"+ _H832b +"',H832c = '"+ _H832c +"',H832d = '"+ _H832d +"',H841a = '"+ _H841a +"',H841b = '"+ _H841b +"',H841c = '"+ _H841c +"',H841d = '"+ _H841d +"',H842a = '"+ _H842a +"',H842b = '"+ _H842b +"',H842c = '"+ _H842c +"',H842d = '"+ _H842d +"',H851a = '"+ _H851a +"',H851b = '"+ _H851b +"',H851c = '"+ _H851c +"',H851d = '"+ _H851d +"',H861a = '"+ _H861a +"',H861b = '"+ _H861b +"',H861c = '"+ _H861c +"',H861d = '"+ _H861d +"',H862a = '"+ _H862a +"',H862b = '"+ _H862b +"',H862c = '"+ _H862c +"',H862d = '"+ _H862d +"'  Where Rnd='"+ _Rnd +"' and SuchanaID='"+ _SuchanaID +"'";
            C.Save(SQL);
        }
        catch(Exception  e)
        {
