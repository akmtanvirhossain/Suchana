...
public class Illness_DataModel {

    String TableName = "Illness";
    Connection C;
    private String _Rnd = "";
    ...
    public List<Illness_DataModel> SelectAll(Context context, String SQL) {
        Connection C = new Connection(context);
        List<Illness_DataModel> data = new ArrayList<Illness_DataModel>();
        Illness_DataModel d = new Illness_DataModel();
        Cursor cur = C.ReadData(SQL);

        cur.moveToFirst();
        while (!cur.isAfterLast()) {
            d = new Illness_DataModel();
