...
public class SES extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            listH324.add("5-সোলার প্লান্ট/বাতি");
            ...
            listH63A.add("3-একটি নির্দিষ্ট ময়লা ফেলার জায়গায়");
            ...
            listH63B.add("3-একটি নির্দিষ্ট ময়লা ফেলার জায়গায়");
            ...
            listH63C.add("3-একটি নির্দিষ্ট ময়লা ফেলার জায়গায়");
            ...
            listH63D.add("3-একটি নির্দিষ্ট ময়লা ফেলার জায়গায়");
...
/*            chkH613b5.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            listH618.add("3-ছাঁকনি বা কাপড়ের ভেতর দিয়ে পানি ছাঁকেন");
