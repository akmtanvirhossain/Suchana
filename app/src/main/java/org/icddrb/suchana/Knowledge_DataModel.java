...
public class Knowledge_DataModel{
    ...
    private String _M2111h = "";
    private String _M2111i = "";
    ...
    public String getM2111h(){
        return _M2111h;
    }

    public void setM2111h(String newValue){
        _M2111h = newValue;
    }

    public String getM2111i(){
        return _M2111i;
    }

    public void setM2111i(String newValue){
        _M2111i = newValue;
    }
    ...
    private String SaveData(Context context)
    {
        ...
        try
        {
            SQL = "Insert into "+ TableName +" (Rnd,SuchanaId,MSlNo,M212,M213a,M213b,M213c,M213x,M213x1,M214,M215,M216,M217a,M217b,M217c,M217d,M217x,M217x1,M218a,M218b,M218c,M218x,M218x1,M219a,M219b,M219c,M219d,M219e,M219f,M2110,M2111a,M2111b,M2111c,M2111d,M2111e,M2111f,M2111g,M2111h,M2111i,M2111x,M2111x1,M2112a,M2112b,M2112c,M2112d,M2112e,M2112f,M2112g,M2112x,M2112x1,M2113a,M2113b,M2113c,M2113d,M2113e,M2113f,M2113g,M2113h,M2113i,M2113j,M2113k,M2113l,M2113M,M2113x,M2113x1,M2114,M2115,M2116,M2117,M221a,M221b,M221c,M221x1,M222a,M222b,M222c,M222d,M222e,M222f,M222g,M222h,M222i,M222x,M222x1,StartTime,EndTime,UserId,EntryUser,Lat,Lon,EnDt,Upload)Values('"+ _Rnd +"', '"+ _SuchanaId +"', '"+ _MSLNumber +"', '"+ _M212 +"', '"+ _M213a +"', '"+ _M213b +"', '"+ _M213c +"', '"+ _M213x +"', '"+ _M213x1 +"', '"+ _M214 +"', '"+ _M215 +"', '"+ _M216 +"', '"+ _M217a +"', '"+ _M217b +"', '"+ _M217c +"', '"+ _M217d +"', '"+ _M217x +"', '"+ _M217x1 +"', '"+ _M218a +"', '"+ _M218b +"', '"+ _M218c +"', '"+ _M218x +"', '"+ _M218x1 +"', '"+ _M219a +"', '"+ _M219b +"', '"+ _M219c +"', '"+ _M219d +"', '"+ _M219e +"', '"+ _M219f +"', '"+ _M2110 +"', '"+ _M2111a +"', '"+ _M2111b +"', '"+ _M2111c +"', '"+ _M2111d +"', '"+ _M2111e +"', '"+ _M2111f +"', '"+ _M2111g +"', '"+ _M2111h +"', '"+ _M2111i +"', '"+ _M2111x +"', '"+ _M2111x1 +"', '"+ _M2112a +"', '"+ _M2112b +"', '"+ _M2112c +"', '"+ _M2112d +"', '"+ _M2112e +"', '"+ _M2112f +"', '"+ _M2112g +"', '"+ _M2112x +"', '"+ _M2112x1 +"', '"+ _M2113a +"', '"+ _M2113b +"', '"+ _M2113c +"', '"+ _M2113d +"', '"+ _M2113e +"', '"+ _M2113f +"', '"+ _M2113g +"', '"+ _M2113h +"', '"+ _M2113i +"', '"+ _M2113j +"', '"+ _M2113k +"', '"+ _M2113l +"', '"+ _M2113M +"', '"+ _M2113x +"', '"+ _M2113x1 +"', '"+ _M2114 +"', '"+ _M2115 +"', '"+ _M2116 +"', '"+ _M2117 +"', '"+ _M221a +"', '"+ _M221b +"', '"+ _M221c +"', '"+ _M221x1 +"', '"+ _M222a +"', '"+ _M222b +"', '"+ _M222c +"', '"+ _M222d +"', '"+ _M222e +"', '"+ _M222f +"', '"+ _M222g +"', '"+ _M222h +"', '"+ _M222i +"', '"+ _M222x +"', '"+ _M222x1 +"', '"+ _StartTime +"', '"+ _EndTime +"', '"+ _UserId +"', '"+ _EntryUser +"', '"+ _Lat +"', '"+ _Lon +"', '"+ _EnDt +"', '"+ _Upload +"')";
            C.Save(SQL);
        }
        catch(Exception  e)
        {
    ...
    public List<Knowledge_DataModel> SelectAll(Context context, String SQL)
    {
        ...
        while(!cur.isAfterLast())
        {
            ...
            d._M2111h = cur.getString(cur.getColumnIndex("M2111h"));
            d._M2111i = cur.getString(cur.getColumnIndex("M2111i"));
