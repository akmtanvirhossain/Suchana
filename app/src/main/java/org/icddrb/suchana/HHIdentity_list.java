...
public class HHIdentity_list extends Activity {
    ...
    public class DataListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            final TextView ResultX = (TextView) convertView.findViewById(R.id.ResultX);
            final TextView H16 = (TextView) convertView.findViewById(R.id.H16);
            final TextView H16X = (TextView) convertView.findViewById(R.id.H16X);
            final TextView H13 = (TextView) convertView.findViewById(R.id.H13);
            ...
            final TextView H08 = (TextView) convertView.findViewById(R.id.H08);
            ...
            ResultX.setText(o.get("ResultX"));
            H16.setText(o.get("H16"));
            H16X.setText(o.get("H16X"));
            H13.setText(o.get("H13"));
